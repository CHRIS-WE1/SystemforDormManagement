        ...
        <div class="col"style="padding: 30px 40px;border: #0b5ed7 solid ;border-radius: 10px">
            ...
            <form action="../ServletMissionExecute?" method="post" class="was-validated"  enctype="multipart/form-data">
                <div class="d-flex flex-column justify-content-center">
                    ...
                    <div class="justify-content-center">
                        <label class="form-label " for="reason">请假事由：</label>
                        <textarea  type="text" class="form-control" id="reason" name="reason" required></textarea></br>
                    </div>
                    <label class="form-label" for="file">提交请假文件：</label>
                    <input  type="file" class="form-control" id="file" name="file" required></br>
                    <div class=" d-flex justify-content-around flex-row">
                        <div><button type="submit" class="btn btn-primary btn-lg p-2" style="align-content: center" >提交</button></div>

    ...
    <div class="container-fluid col row">
        <div class="col">
            ...
            <%
                ...
                if(pageNow!=1){
                    out.print("<li class='page-item'><a class='page-link' href='MissionForTea.jsp?pageNow=1'>首页</a></li>");
                    out.print("<li class='page-item'><a class='page-link' href='MissionForTea.jsp?pageNow="+(pageNow-1)+"'>上一页</a></li>");
                }
                //显示分页
                for(int i=1; i<=pageCount;i++){
                    out.print("<li class='page-item'><a class='page-link' href='MissionForTea.jsp?pageNow="+i+"'>"+i+"</a></li>");
                }
                if(pageNow<pageCount){
                    out.print("<li class='page-item'><a class='page-link' href='MissionForTea.jsp?pageNow="+(pageNow+1)+"'>下一页</a></li>");
                    out.print("<li class='page-item'><a class='page-link' href='MissionForTea.jsp?pageNow="+pageCount+"'>尾页</a></li>");
                }
                out.print("</ul>");
            %>
        </div>

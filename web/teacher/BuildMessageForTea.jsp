...
<div class="container-fluid">
    ...
    <div class="container-fluid col row">
        <div class="col"style="padding: 30px 40px;border: #0b5ed7 solid ;border-radius: 10px">
            <form action="../ServletTeaIndex?action=buildupdatepre" method="post" class="was-validated">
                <%
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="buildname" name="buildname" value="<%=build.getBuildname()%>" readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" rows="5" id="details" name="details" readonly><%=build.getDetails()%></textarea>
                </div>

...
<div class="container-fluid">
    ...
    <div class="container-fluid col row">
        <div class="col"style="padding: 30px 40px;border: #0b5ed7 solid ;border-radius: 10px">
            <form action="../ServletTeaIndex?action=roominsert" method="post" class="was-validated">
                <%
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input type="text" class="form-control" id="buildname" name="build" value="<%=tea.getBuildid()%>|<%=tea.getBuildname()%>" readonly>
                </div>
                <div class="mb-3">

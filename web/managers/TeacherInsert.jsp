...
<div class="container-fluid">
    ...
    <div class="container-fluid col-12 row">
        ...
        <div class="col-10"style="padding: 30px 40px;border: #0b5ed7 solid ;border-radius: 10px">
            <form action="../ServletManIndex?action=teainsert" method="post" class="was-validated">
                <%
                    String teano =(String) session.getAttribute("NewTeaNo");
                %>
                <div class="d-flex justify-content-between flex-row ">
                    <div class="col-5">
                        <label class="form-label" for="tno">职工号：</label>
                        <input type="text" class="form-control" id="tno" name="tno" value="<%=teano%>" readonly>
                    </div>
                    <div class="col-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="username" name="username"  value="<%=teano%>" required>
                    <div class="valid-feedback">验证成功</div>
                    <div class="invalid-feedback">用户名不能为空</div>
                </div>
                <div class="mb-3">
                    <label class="form-label" for="pwd">设置初始密码：</label>
                    <input type="text" class="form-control" id="pwd" name="pwd" value="123456" required>
                    <div class="valid-feedback">验证成功</div>
                ...
                <div class="d-flex justify-content-between flex-row">
                    <div class="col-5">
                        ...
                        <select class="form-control" name="build" id="build" >
                            <%ArrayList<Build> builds = (ArrayList<Build>) session.getAttribute("BuildWithoutTea");

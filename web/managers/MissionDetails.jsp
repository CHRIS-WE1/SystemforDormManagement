...
<script>
    ...
    function alter(missionid) {
        window.location="../ServletManIndex?action=missionupdatepre&missionid="+missionid;
    }
</script>
<div class="container-fluid">
    ...
    <div class="container-fluid col row">
        <div class="col"style="padding: 30px 40px;border: #0b5ed7 solid ;border-radius: 10px">
            <%Mission mission = (Mission) session.getAttribute("MissionDetails");%>
            <form action="" method="post" class="was-validated">
                <div class="d-flex flex-column justify-content-center">
                    ...
                    <div class=" d-flex justify-content-around flex-row">
                        <div><button type="button" class="btn btn-danger btn-lg p-2" style="align-content: center" onclick="alter(<%=mission.getMissionid()%>)">修改任务</button></div>

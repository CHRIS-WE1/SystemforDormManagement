...
<div class="container-fluid">
    ...
    <div class="container-fluid col-12 row">
        ...
        <div class="col-10"style="padding: 30px 40px;border: #0b5ed7 solid ;border-radius: 10px">
            <form action="../ServletManIndex?action=studentupdate" method="post" class="was-validated">
                <%
                    Student student =(Student) session.getAttribute("UpdateStu");
                %>
                ...
                <div class="d-flex justify-content-between flex-row">
                    <div class="col-5">
                        ...
                        <input type="text" class="form-control" name="buildname" id="locbuild" value="<%=student.getBuildname()%>" >
                    </div>
                    <div class="col-4">
                        <label class="form-label" for="locroom">所在宿舍：</label>
                        <input type="text" class="form-control" id="locroom" name="roomname" value="<%=student.getRoomname()%>" >
                    </div>
                </div>
            </br>

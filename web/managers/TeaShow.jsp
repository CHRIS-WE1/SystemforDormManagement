...
<script>
    ...
    function back(){
        window.location="./TeaMessageforMan.jsp";
    }
</script>
    ...
    <div class="container-fluid col row">
        <div class="col">
                ...
                <form method="post" class="p-2 border-bottom border-primary pb-0" action="../ServletManIndex?action=teasearch">
                    <div class="container justify-content-between d-flex flex-row">
                        <div class="d-flex justify-content-start p-1 mb-0">
                            <div>
                                <button class="btn btn-sm btn-success" type="button" onclick="back()">返回</button>
                            </div>
                        </div>
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <%
                    ArrayList<Teacher> teachers = (ArrayList<Teacher>)  session.getAttribute("restea");
                    if(teachers!=null){

...
@WebServlet(name = "ServletMissionUpdate", value = "/ServletMissionUpdate")
@MultipartConfig
public class ServletMissionUpdate extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            Mission mission = (Mission) request.getSession().getAttribute("UpdateMission");
            ...
            if(dao.MissionUpdate(mission)>0)
            {
